...
def make_parser():
    ...
    parser.add_argument("--track_high_thresh", type=float, default=0.4, help="tracking confidence threshold")
    parser.add_argument("--track_low_thresh", type=float, default=0.1, help="tracking confidence threshold")
    parser.add_argument("--new_track_thresh", type=float, default=0.7, help="tracking confidence threshold")
...
def bytetrack(bboxes, scores,cls,tracker):
    if bboxes.shape[0]>0:
        ...
        # print([t[-1]for t in online_targets])
